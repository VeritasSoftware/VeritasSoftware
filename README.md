...
|*.NET WebRTC*|A .NET library for WebRTC, enabling real-time (audio and video) communication in your web applications. Blazor & Angular clients.|[Browse](https://github.com/VeritasSoftware/WebRTC)|
